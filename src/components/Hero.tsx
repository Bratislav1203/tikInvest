  ...
  return (
    <section className="relative h-screen flex items-center justify-center bg-primary overflow-hidden">
      ...
      <div className="relative z-10 container text-center text-white px-4 animate-fade-in">
        <div className="mb-10 animate-slide-up mt-24">
          <img
            src="logo.png"
            alt="Tik Invest"
            className="h-32 md:h-48 w-auto mx-auto mb-8 drop-shadow-2xl filter brightness-0 invert"
          />
        </div>

        <h1 className="font-heading text-3xl md:text-5xl lg:text-6xl font-light mb-6 leading-tight tracking-tight">
          SAVREMENI STAMBENI <br />
          <span className="text-secondary font-medium">OBJEKAT U RAŠKI</span>
        </h1>

        <p className="max-w-2xl mx-auto text-slate-300 text-lg md:text-xl font-light mb-12 tracking-wide">
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 mt-8">
          {[
            ...
            <div
              key={index}
              className="flex items-center gap-3 px-6 py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full hover:bg-white/10 transition-colors cursor-default"
            >
        ...
        <div className="mt-16 flex flex-col md:flex-row items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <button
